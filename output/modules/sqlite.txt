...
1.  [download](http://www.silverstripe.org/sqlite-database/), unzip and copy the sqlite3 folder to your project root so that it becomes a sibling of cms, sapphire and co.
...
1.  [download](http://www.silverstripe.org/sqlite-database/), unzip and copy the sqlite3 folder to your project root so that it becomes a sibling of cms, sapphire and co.
2.  add the following to your [_environment.php](http://doc.silverstripe.org/doku.php?id=environment-management) file: `define('SS_DATABASE_CLASS', 'SQLiteDatabase');`
...
If you get an error message like "VACUUM | not authorized" or "VACUUM | authorization required", turn off vacuuming by adding: `SQLite3Database::$vacuum = false;` anywhere in your mysite/_config.php.
...
If you are looking for a SQLite client for debugging your SS app, [sqlite-manager](http://code.google.com/p/sqlite-manager/) plugin for firefox may be worth a try.
