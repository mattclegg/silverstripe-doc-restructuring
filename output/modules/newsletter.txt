...
## Download
*  [0.1](http://open.silverstripe.com/changeset/latest/modules/newsletter/tags/0.1?old_path=/&filename=/modules/newsletter/tags/0.1&format=zip) (Latest Release)
*  [Daily Build](http://open.silverstripe.com/changeset/latest/modules/newsletter/trunk?old_path=/&filename=/modules/newsletter/trunk&format=zip) ("trunk")
...
We’ve undergone a usability review of the email section and have decided to make a few changes to make the section more usable and easy to use. Please bear with us through this process. Feedback can be added to our forums, or to support@silverstripe.com
