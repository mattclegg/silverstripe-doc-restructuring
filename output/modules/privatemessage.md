...
5.  check your admin backend for a new page called "private-message" and rename if you like. Also I suggest you hide the page from not logged in users, although the page checks for permissions on call ;-)
