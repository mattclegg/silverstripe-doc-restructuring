...
Mollom is a module which sits atop the [Spam Protection](modules/spamprotection) module to reduce spam comments on your website.
...
2. Do the same for the [Spam Protection Module](modules/spamprotection) (Download and unzip into  a new spamprotection folder.)
...
See how to use the Spam protection module on the [ Using Spam Protector Section](modules/spamprotection#using_spam_protector_in_your_forms) 
