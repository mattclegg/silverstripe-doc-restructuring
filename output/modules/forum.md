## Introduction
The forum module allows you to create a community of people who can share information. The forum code runs SilverStripe's forum, so [check out the site for a demo](http://www.silverstripe.com/silverstripe-forum/).
...
## Download
*  [0.2.5](http://open.silverstripe.com/changeset/latest/modules/forum/tags/0.2.5?old_path=/&filename=/modules/forum/tags/0.2&format=zip) Latest Stable Release

*  [Daily Build](http://open.silverstripe.com/changeset/latest/modules/forum/trunk?old_path=/&filename=/modules/forum/trunk&format=zip) ("trunk")
...
*  Format your post using [BBCode](http://en.wikipedia.org/wiki/Bbcode) (some codes exist on these forums that aren't noted on the Wikipedia article).
*  Attach files
