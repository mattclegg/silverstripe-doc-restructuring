...
*  [Daily Build](http://open.silverstripe.com/changeset/latest/modules/userforms/trunk?old_path=/&filename=/modules/userforms/trunk&format=zip)
...
4.  Place this directory in your sites root directory. This is the one with sapphire/cms/jsparty in it. See [Installing Modules](http://doc.silverstripe.com/doku.php?id=installing-modules) for an introduction to installing.
