...
SilverStripe stores alot of its site developer tools in static methods and class's which you can control via a _config.php file in your mysite/ folder (or tutorial/ folder if you installed with the tutorial)
