# Overview
[tutorial:2-extending-a-basic-site](http://doc.silverstripe.com/doku.php?id=tutorial:2-extending-a-basic-site) gives us a great method for [showing the latest news on the homepage](tutorial/2-extending-a-basic-site#showing_the_latest_news_on_the_homepage). But what if you have a Latest News section and a Client News section, and you want to display 5 of the latest of EITHER kind of news?
