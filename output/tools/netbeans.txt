# NetBeans
[NetBeans](ttp///www.netbeans.org/) is a mature open source IDE developed in Java that works on all major platforms.  It now boasts a PHP specific version that is tailored to PHP5 and web development. Integrated features include:
...
The above are built-in, as opposed to [other IDEs](tools/eclipse) that require multiple plugins for each feature.  More information is available at http://www.netbeans.org/
