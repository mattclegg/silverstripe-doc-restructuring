...
object-properties by [casting](casting) its string value into a
[DBField](http://api.silverstripe.org/current/sapphire/model/DBField.html) object.
...
The [Convert](Convert) class has utilities for this, mainly *Convert::raw2xml()* and *Convert::raw2att()* (which is also
