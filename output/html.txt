...
See [ContentNegotiator](http://api.silverstripe.org/2.3/sapphire/control/ContentNegotiator.html) class for automatically converting between HTML and XHTML in SilverStripe responses (deprecated as of SilverStripe 2.4).
